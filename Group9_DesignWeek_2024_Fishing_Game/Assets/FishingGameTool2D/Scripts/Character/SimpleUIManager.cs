...
namespace FishingGameTool2D.Example
{
    ...
    public class SimpleUIManager : MonoBehaviour
    {
        ...
        private FishingLineStatus2D _lineStatus;
        ...
        {
            if (_fishingSystem._fishingRod._fishingFloat != null || !_fishingSystem._castInput)
            {
            ...
            float castProgress = CalculateProgess(_fishingSystem._gameViewType == GameViewType.SideView ? _fishingSystem._currentCastForce : _fishingSystem._currentCastTime,
                _fishingSystem._gameViewType == GameViewType.SideView ? _fishingSystem._maxCastForce : _fishingSystem._maxCastTime);
        ...
        private void ShowLootInfo(FishingLootData lootData, Text infoGameObject)
        {
